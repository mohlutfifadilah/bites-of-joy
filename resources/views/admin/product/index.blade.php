                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Data Product</h4>
                                <a href="{{ route('product.create') }}" class="btn btn-success btn-md ml-auto">
                                    ...
                                    <tbody>
                                        @foreach ($product as $p)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('img/product/upload/' . $p->photo) }}" alt="" class="img-fluid">
                                                </td>
                                                <?php
                                                    $category = \App\Models\Category::find($p->id_category);
                                                ?>                                                
