                                    ...
                                    <div class="col-lg-4">
                                        <div class="product__discount__item">
                                            ...
                                            <div class="product__discount__item__text">
                                                <span>{{ $p->name_category }}</span>
                                                <h5><a href="#">{{ $p->name_product }}</a></h5>
                                                <?php
                                                $diskon = $p->price * (20 / 100);
                                                ?>
                                                <div class="product__item__price">@currency($p->price - $diskon)
